...
\begin{center}
\begin{lstlisting}[caption=GLM Model 1. ,label=out.glm1]
...
\begin{center}
\begin{lstlisting}[caption=GLM Model 2 ,label=out.glm2]
...
\begin{center}
\begin{lstlisting}[caption=GLM Model 3. ,label=out.glm3]
...
\begin{center}
\begin{lstlisting}[caption=GLM Model 4. ,label=out.glm4]
...
\newpage
\begin{center}
\begin{lstlisting}[caption=GLMM model. ,label=out.glmm]
...
\newpage
\begin{center}
\begin{lstlisting}[caption=Random effect predictions of the GLMM model. ,label=out.glmm.ref]
> ranef(fit_glmm)
$Plant
     (Intercept)
Qn1 -0.12415774
...
\begin{center}
\begin{lstlisting}[caption=GAMM Model. ,label=out.gamm]	
...
\begin{center}
	\begin{lstlisting}[caption=GEE Model ,label=out.gee]
