...
\vspace{0.5cm}
\textbf{Objectif :} Expliquer le principe de l'estimation ponctuelle : qu'est-ce qu'un estimateur, quelles sont ses propriétés souhaitables (biais, variance) et comment choisir entre plusieurs estimateurs.
...
\begin{enumerate}
    ...
    \item Expliquer les notions de biais et de variance d'un estimateur, avec au moins un exemple d'estimateur biaisé;
