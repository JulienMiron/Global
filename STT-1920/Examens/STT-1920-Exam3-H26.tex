...
\pageblanche
\question[12] Une équipe en sciences biomédicales veut vérifier s'il existe une différence de réponse inflammatoire moyenne (score quantitatif) selon la concentration d'un agent actif dans une formulation.
