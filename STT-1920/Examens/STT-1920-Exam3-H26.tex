...
\textbf{Saveur} & Noir & Lait & Caramel & Noisette & \textbf{Total}\\
\hline
...
\begin{parts}
\part[1] Formulez les hypothèses nulle et alternative du test du khi-carré d'ajustement.
...
\part[2] Au seuil $\alpha=0{,}05$, quelle est votre conclusion? Justifiez. On donne $\chi^2_{0{,}05;\,3}=7{,}815$.
...
\pageblanche
%%%%%%%%%%%%%%%% QUESTION 8 — Test du khi-carré d'homogénéité %%%%%%%%%%%%%%%%
\question[8] On souhaite savoir si la répartition des choix de transport (auto, transport en commun, vélo) est la même pour les étudiants de trois campus universitaires. Un échantillon aléatoire de 300 étudiants donne les résultats suivants.

\begin{center}
\begin{tabular}{l|ccc|c}
 & \textbf{Auto} & \textbf{Transport en commun} & \textbf{Vélo} & \textbf{Total}\\
\hline
\textbf{Campus A} & 40 & 45 & 15 & 100\\
\textbf{Campus B} & 30 & 50 & 20 & 100\\
\textbf{Campus C} & 20 & 40 & 40 & 100\\
\hline
\textbf{Total} & 90 & 135 & 75 & 300
\end{tabular}
\end{center}

\begin{parts}
\part[1] Formulez les hypothèses nulle et alternative.

\begin{solution}
$H_0$~: La distribution des choix de transport est la même pour les trois campus.

$H_1$~: La distribution des choix de transport diffère pour au moins un campus.
\end{solution}
...
\begin{center}
\begin{tabular}{l|ccc}
 & Auto & Transport en commun & Vélo \\
\hline
Campus A & $\frac{100\times 90}{300}=30$ & $\frac{100\times 135}{300}=45$ & $\frac{100\times 75}{300}=25$ \\[4pt]
Campus B & $30$ & $45$ & $25$ \\[4pt]
Campus C & $30$ & $45$ & $25$
\end{tabular}
\end{center}
...
\begin{align*}
D_0 &= \frac{(40-30)^2}{30}+\frac{(45-45)^2}{45}+\frac{(15-25)^2}{25}\\
&\quad +\frac{(30-30)^2}{30}+\frac{(50-45)^2}{45}+\frac{(20-25)^2}{25}\\
&\quad +\frac{(20-30)^2}{30}+\frac{(40-45)^2}{45}+\frac{(40-25)^2}{25}\\[4pt]
&= \frac{100}{30}+0+\frac{100}{25}+0+\frac{25}{45}+\frac{25}{25}+\frac{100}{30}+\frac{25}{45}+\frac{225}{25}\\[4pt]
&= 3{,}333+0+4+0+0{,}556+1+3{,}333+0{,}556+9\\[4pt]
&= 21{,}778
\end{align*}
\end{solution}
...
\begin{solution}
$\nu = (r-1)(c-1) = (3-1)(3-1) = 4$ degrés de liberté ($r=3$ lignes, $c=3$ colonnes).
\end{solution}

\part[2] Au seuil $\alpha=0{,}05$, quelle est votre conclusion? Justifiez. On donne $\chi^2_{0{,}05;\,4}=9{,}488$.

\begin{solution}
$D_0 = 21{,}778 > 9{,}488 = \chi^2_{0{,}05;\,4}$.

On rejette $H_0$. Au seuil de 5\,\%, la distribution des choix de transport n'est pas la même pour les trois campus. En particulier, le campus C semble avoir une proportion de cyclistes nettement plus élevée.
\end{solution}
...
\hline
\textbf{Stress faible} & 50 & 10 & 60\\
\textbf{Stress modéré} & 45 & 35 & 80\\
\textbf{Stress élevé} & 15 & 45 & 60\\
\hline
