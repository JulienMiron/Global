...
\question[5] Un échantillon de taille $n=16$ provenant d'une population normale donne $\overline{x}=45$ et $s=4$. On calcule un intervalle de confiance pour $\mu$ à un certain niveau de confiance et on obtient $[42{,}869;\, 47{,}131]$. Quel est le niveau de confiance de cet intervalle? Montrez votre démarche.
