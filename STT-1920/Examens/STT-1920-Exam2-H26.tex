...
\part[2] Un estimateur sans biais a toujours une erreur quadratique moyenne (EQM) plus faible qu'un estimateur biaisé.
...
\part[2] L'erreur quadratique moyenne d'un estimateur sans biais est égale à sa variance.
...
\part[2] Si le biais d'un estimateur $\hat{\theta}$ est négatif, alors $\hat{\theta}$ surestime $\theta$ en moyenne.
