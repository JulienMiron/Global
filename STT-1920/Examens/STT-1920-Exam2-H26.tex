...
\begin{parts}
\part[8] Construisez un intervalle de confiance de niveau 95\% pour $\mu$.
...
\begin{parts}
\part[8] Construisez un intervalle de confiance de niveau 99\% pour la concentration moyenne $\mu$ de chlorophylle dans ce lac.
...
\part[8] Construisez un intervalle de confiance de niveau 95\% pour $p$.
