...
\pageblanche
\question[10]\label{variance} Un ingénieur veut vérifier la stabilité d'une machine-outil. Il mesure le diamètre de 25 pièces produites et obtient une variance échantillonnale de $s^2=0{,}012$ cm$^2$. On suppose que les diamètres suivent une loi normale. Construisez un intervalle de confiance de niveau 95\% pour la variance $\sigma^2$.
...
\question[7] Un échantillon de taille $n=16$ provenant d'une population normale donne $\overline{x}=45$ et $s=4$. On calcule un intervalle de confiance pour $\mu$ à un certain niveau de confiance et on obtient $[42{,}869;\, 47{,}131]$. Quel est le niveau de confiance de cet intervalle? 
