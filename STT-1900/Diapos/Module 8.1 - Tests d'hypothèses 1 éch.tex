...
\item Vous obtenez une moyenne échantillonnale de $\overline x = 81,6$ MPa. Pouvez-vous conclure quelque chose? \href{https://jmiron.shinyapps.io/IntroTest/}{Illustration}
\end{enumerate}
...
\href{https://jmiron.shinyapps.io/valeurP/}{Illustration}
\end{center}
...
\href{https://jmiron.shinyapps.io/exempleDes/}{En simulation}
\end{frame}
