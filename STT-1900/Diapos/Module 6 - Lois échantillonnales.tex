...
\vfill
    \href{https://jmiron.shinyapps.io/MoyEchNorm/}{Simulons cette expérience !}
...
% \vfill
%     \href{https://jmiron.shinyapps.io/EstimationIntro/}{Exemple quand $X\sim\mathcal{N}(\mu,\sigma^2)$.}
% \end{frame}
...
\vspace{0.5cm}
\vfill
    \href{https://jmiron.shinyapps.io/MoyEchExp/}{Simulation.}
\end{frame}
...
\vspace{0.5cm}
\vfill
    \href{https://jmiron.shinyapps.io/MoyEchNorm/}{P.ex., si $\mu=10$, $\sigma^2=4$ et $n=16$, alors $\overline{X}\sim\mathcal{N}(10,4/16)$ ... simulons !}
   }
\end{frame}
...
\begin{frame}[t]{Standardisation}
  ...
  \vspace{0.5cm}
\vfill
    \href{https://jmiron.shinyapps.io/MoyEchNorm/}{Retour à la simulation ...}
\end{frame}
...
\begin{frame}[t]{Exemple 3}
    ...
    \href{https://jmiron.shinyapps.io/ExempleKhiCarre/}{Simulation, question de mettre les calculs en contexte ...}
\end{frame}
...
\href{https://jmiron.shinyapps.io/StdSvSigma/}{Simulation}
...
\end{Boite}
 ...
 \href{https://jmiron.shinyapps.io/Student/}{Graphiquement}
\end{frame}
