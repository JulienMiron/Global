...
\part[1] Quelle est la valeur de \texttt{AAA}?
...
\part[3] Calculez la valeur de \texttt{BBB}, le $R^2$ ajusté. \textbf{\textit{Donnez les détails de votre démarche.}}
...
\begin{align*}
    H_0 &: \text{aucune des variables indépendantes n'a d'effet sur la résistance à la compression,}\\
    H_1 &: \text{au moins une variable indépendante a un effet sur la résistance à la compression.}
\end{align*}
