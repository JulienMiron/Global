...
\pageblanche
\question[6] Soit $X_1,\hdots,X_n$ qui indépendants et identiquement distribués selon une loi quelconque $F_X$. 
...
\question[8] Soit $X_1,\hdots,X_{4}$ et $Y_1,\hdots,Y_{3}$ deux échantillons aléatoires provenant respectivement de lois normales d'espérances $\mu_X$ et $\mu_Y$ et de variance $\sigma^2_X$ et $\sigma^2_Y$, supposées inégales.
