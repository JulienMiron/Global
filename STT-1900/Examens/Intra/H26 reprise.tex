...
\end{solution}
    ...
    \question[8] Soit $X_1,\hdots,X_{121}$, des variables aléatoires provenant d'une loi normale d'espérance $\mu=0$ et de variance $\sigma^2=25$. Quelle est la probabilité que $\displaystyle\left|\frac{\overline{X}}{S}\right|$ soit plus grand que $0{,}26$, où $S$ est l'écart-type échantillonnal?
