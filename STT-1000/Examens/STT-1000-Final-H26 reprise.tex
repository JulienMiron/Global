...
\question[4]
Soit $X_1,\ldots,X_n$ un échantillon aléatoire simple issu d'une loi $\mathcal{N}(\mu,\sigma^2)$, et soit $S^2$ la variance échantillonnale. Sachant que
\[
\frac{(n-1)S^2}{\sigma^2}
\]
suit une loi du khi-carré à $n-1$ degrés de liberté, donnez $\text{Var}(S^2)$ en fonction de $\sigma^2$ et $n$. \textbf{\textit{Donnez les détails de votre démarche.}}
