...
On obtient $\overline{x}=26,112$, $\overline{y}=12$, $s_X^2=120$ et $s_Y^2=28$. Quel est le seuil observé du test?
...
$$t_0=\frac{\overline{x}-\overline{y}}{se}=\frac{26{,}112-12}{3}=\frac{14{,}112}{3}=4{,}704.$$
...
Le seuil observé est $\alpha^*=P(T_{25}>4{,}704)$. D'après la table de la loi $t$, $t_{0{,}0005,\,25}=3{,}725$. Puisque $t_0=4{,}704>3{,}725$, on a $\alpha^*<0{,}0005$. On rejette $H_0$ au seuil $5\%$.
\end{solution}
\pageblanche
