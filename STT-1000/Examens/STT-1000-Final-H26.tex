...
\question
Une entreprise fabrique des barres de chocolat et s'intéresse à la variabilité de la quantité de sucre dans les barres. Elle choisit au hasard 11 barres. Dans l'échantillon, la quantité moyenne de sucre par barre est de $20,05 \,g$ et la variance échantillonnale est de $7,995\, g^2$. Sachant que $X$, la quantité de sucre dans une barre, est une variable aléatoire qui suit une loi normale d'espérance $\mu$ et de variance $\sigma^2$, elle fait le test suivant, au seuil $\alpha=2,5\%$,
\begin{align*}
	H_0 &: \sigma^2 = 5 \cr
	H_1 &: \sigma^2 > 5.
\end{align*}
...
\pageblanche
\question[10] Soit $X_1,\hdots,X_{24}$ et $Y_1,\hdots,Y_{7}$ deux échantillons aléatoires provenant respectivement de lois normales d'espérances $\mu_X$ et $\mu_Y$ et de variance $\sigma^2_X$ et $\sigma^2_Y$, supposées inégales.
